            ...
            <div className="bg-home h-screen bg-cover bg-no-repeat flex">
                ...
                <form>
                    ...
                    <div className="flex justify-center mt-20">
                        <button type="submit" className="bg-gray px-6 py-2.5 leading-tight uppercase text-white rounded-xl shadow-md hover:bg-gray-green w-56">Login</button>   
                    </div>
                    <div className="flex justify-center mt-5 mb-5">
                        <a href="#" className="font-bold shadow-sm hover:shadow-lg hover:border-b-2">Create Account</a>
                    </div>
                    </form>                 
                </div>
            </div>
