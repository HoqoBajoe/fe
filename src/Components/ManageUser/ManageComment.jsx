                        ...
                        <tbody>
                            ...
                            <tr key={item.id} className="border-b">
                                ...
                                <td className='flex'>
                                    ...
                                    item.status === "Pending" ? 
                                    <div>
                                        <button className=' bg-green text-white rounded-lg font-semibold m-3 p-1 mb-1 w-16 hover:shadow-md'onClick={()=>acceptReview(item.id)}>Accept</button>
                                        <button className=' bg-red text-white rounded-lg font-semibold m-3 p-1 w-16' onClick={()=>rejectReview(item.id)}>Reject</button>
                                    </div>
                                    : 
                                    null
                                    }
